...
Page({
  data: {
    ...
    updatePangzhanUrl: '/snJbjPzjl/update',
    pang:{
      tryDataUrl:[]
    }
  },
  onLoad: function (options) {
    ...
    if (options.pileCode) {
      ...
      this.getOrCreate("/snJbjPzjl/add", this.afterGetOrCreate);
    }   
  },
  onShow: function () {
  ...
  afterGetOrCreate: function (obj) {
    this.setData({
      ...
      currentHjshPropList: obj.hjshProp ? obj.hjshProp.split(",") : this.data.currentHjshPropList
    })
  },
/**
//    * 水灰比
